...
SOURCE_URLS = [
   ...
   "https://raw.githubusercontent.com/ShatakVPN/ConfigForge-V2Ray/main/configs/all.txt",
    ...
    "https://us.lxg001.cc.cd/sub?token=eb765d258de80d717533193d94cb92a2",
    ...
    "https://gh-proxy.com/raw.githubusercontent.com/Barabama/FreeNodes/refs/heads/feat/ai-crawler-v2/nodes/nodev2ray.txt",
...
def make_node_name(item, idx, force_residential=False):
    ...
    return f"{flag} {cname} {idx:02d}{tag}{risk_tag} - 刘晓光"
...
> 👤 **定制规范命名**: 所有订阅节点均重命名为 `国旗 地区 序号 (家宽) - 刘晓光`
